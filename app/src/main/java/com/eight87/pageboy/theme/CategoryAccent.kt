 ...
 *
 * Hand-picked palette (sky blue, purple, pink, magenta, orange, peach,
 * green) — identical to tonearmboy's set so the family's visual
 * register matches across apps. Per row, we pick by hashing the row's
...
private val DarkPalette = listOf(
  ...
  CategoryAccent(container = Color(0xFF5C1F45), onContainer = Color(0xFFFFB1D8)), // magenta
  CategoryAccent(container = Color(0xFF5C3300), onContainer = Color(0xFFFFB877)), // orange
  CategoryAccent(container = Color(0xFF5C3D24), onContainer = Color(0xFFFFC59A)), // peach
